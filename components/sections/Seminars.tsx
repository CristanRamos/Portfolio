...
function SeminarItem({ title, subtitle, index }: { title: string; subtitle: string; index: number }) {
    ...
    return (
        <div ref={ref}>
            <div
                className={`p-4 rounded-lg border border-border hover:bg-muted/30 transition-all duration-700 ease-out ${isInView
            ...
            >
                ...
                <p className="text-xs text-muted-foreground mt-2">National University Dasmariñas</p>
            </div>
        </div>
    )
}
